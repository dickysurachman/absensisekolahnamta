...
<div class="profile-view">
    ...
    <?= Html::a('Update', ['mauupdatebib', 'id' => $model->id], ['class' => 'btn btn-primary']) ?>
    <?= Html::a('Print', ['printbib', 'id' => $model->id], ['target'=>'_blank','class' => 'btn btn-primary']) ?>
    <p>
    </p>
...
//            'sdl',
    ...
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'pjax'=>true,
            'columns' => require(__DIR__.'/_columnsbibsdm.php'),
            'toolbar'=> [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>', ['createbibsdm'],
    ...
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'pjax'=>true,
            'columns' => require(__DIR__.'/_columnsbibsdl.php'),
            'toolbar'=> [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>', ['createbibsdl'],
    ...
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'pjax'=>true,
            'columns' => require(__DIR__.'/_columnsbib.php'),
            'toolbar'=> [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>', ['createbib'],
