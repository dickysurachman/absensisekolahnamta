...
/**
 * Ab1Controller implements the CRUD actions for Absen model.
 */
class Ab1Controller extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {   
        ...
        if($request->isAjax){
            ...
            return [
                    'title'=> "Absen #".$id, $id_siswa,
                    'content'=>$this->renderAjax('view', [
                        'model' => $this->findModel($id, $id_siswa),
                    ]),
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                            Html::a('Edit',['update','id, $id_siswa'=>$id, $id_siswa],['class'=>'btn btn-primary','role'=>'modal-remote'])
                ];    
        }else{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Absen",
                    'content'=>'<span class="text-success">Create Absen success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id, $id_siswa)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update Absen #".$id, $id_siswa,
    ...
    /**
     * Delete an existing Absen model.
     * For ajax request will return json object
    ...
    public function actionDelete($id, $id_siswa)
    {
     ...
     /**
     * Delete multiple existing Absen model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @param integer $id_siswa
